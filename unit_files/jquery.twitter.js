	...
	$.fn.getTwitter = function(options) {
		...
		function twitterCallback2(twitters) {
		  ...
		  for (var i=0; i<twitters.length; i++){
			...
			statusHTML.push('<li><div class="twitt-body"><a class="profileLink" href="http://twitter.com/'+o.userName+'">'+o.userName+' </a>'+status+' <a class="timesince" href="http://twitter.com/'+username+'/statuses/'+twitters[i].id_str+'">'+relative_time(twitters[i].created_at)+'</a></div></li>');
		  }
		  var id = '';
		  id = o.id;
		...
		$.getJSON("http://api.twitter.com/1/statuses/user_timeline.json?screen_name="+o.userName+"&callback=?&count="+o.numTweets, function(data) {twitterCallback2(data);
